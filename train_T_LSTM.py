...
if __name__ == '__main__':
    ...
    if args.test_mode == 1:
        ...
        checkpoint = torch.load('./saved_weights/T-LSTM', map_location='cpu')
        ...
        with torch.no_grad():
            ...
            for each_batch in range(test_data_gen.steps):
                ...
                test_output = model(test_x, test_time)
        ...
        for each_chunk in range(args.epochs):
            ...
            for each_batch in range(train_data_gen.steps):
                ...
                cur_output = model(batch_x, batch_time)
            ...
            with torch.no_grad():
                ...
                for each_batch in range(val_data_gen.steps):
                    ...
                    valid_output = model(valid_x, valid_time)
